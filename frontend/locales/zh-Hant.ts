...
export const zhHant: LocalePack = {
  ...
  "status.copying": "正在複製第 {current} 項, 共 {count} 項...",
  "status.moving": "正在搬移第 {current} 項, 共 {count} 項...",
  "status.pasteConflict": "\"{name}\" 已存在.",
  "status.pasteTypeMismatch": "\"{name}\" 已存在, 且種類不同.",
  "status.pasteCanceled": "已取消. {count} 個項目中已處理 {done} 個.",
  "status.pasteDisconnected":
    "處理 \"{name}\" 時連線中斷, 該項結果未知. {count} 個項目中已處理 {done} 個.",
