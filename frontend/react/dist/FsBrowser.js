...
export function FsBrowser(props) {
    ...
    return (_jsxs("div", { className: "fsb-root", style: cssVars, onContextMenu: (event) => event.preventDefault(), children: [_jsx("style", { children: FSB_STYLE_CSS }), _jsxs("div", { className: "fsb-titlebar", children: [_jsx("span", { className: "fsb-title", children: t("title") }), _jsx("span", { className: "fsb-mode-hint", children: selectionMode === "dir" ? t("mode.dir") : t("mode.file") })] }), _jsxs("div", { className: "fsb-toolbar", children: [_jsx("button", { type: "button", className: "fsb-btn", "aria-label": t("toolbar.up"), title: t("toolbar.up"), disabled: busy || snapshot.atRoot, onClick: () => void store.goUp(), children: _jsx(IconUp, {}) }), _jsx("button", { type: "button", className: "fsb-btn", "aria-label": t("toolbar.home"), title: t("toolbar.home"), disabled: busy, onClick: () => void store.goHome(), children: _jsx(IconHome, {}) }), _jsx(RootSwitcher, { roots: snapshot.roots, currentRoot: snapshot.currentRoot, pathStyle: snapshot.pathStyle, disabled: busy, ariaLabel: t("toolbar.root"), onSwitch: (root) => void store.switchRoot(root) }), _jsx("input", { className: "fsb-path-input", value: pathDraft, placeholder: t("toolbar.pathPlaceholder"), disabled: snapshot.loading, onFocus: () => {
