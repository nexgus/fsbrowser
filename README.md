...
- **The bridge service**, in [`fsb/service/`](fsb/service/), is fsbrowser's own code -- you register it but do not modify it. It exposes your implementation to the front end through generated bindings and normalizes whatever errors it returns into the structured form the component expects.
...
| Package | Contents |
|---|---|
| `github.com/nexgus/fsbrowser/fsb` | Go module: interface definition and bridge service |
